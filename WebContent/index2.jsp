...
#floating-panel {
  ...
  &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
            ...
            <a class="btn btn-danger" href="http://sm11-frm72nkcpb.elasticbeanstalk.com/geochart.jsp">TweetGeo</a> 
       <a class="btn btn-success" href="http://sm11-frm72nkcpb.elasticbeanstalk.com/Trend.jsp">TweetApp</a>
       </ul>
  ...
  return [
    ...
    new google.maps.LatLng(37.782842, -122.443688),
            ...
            function openSocket(){
                ...
                if(webSocket1 !== undefined && webSocket1.readyState !== WebSocket.CLOSED){
                    writeResponse("WebSocket is already opened.");
                     return;
                 }
                // Create a new instance of the websocket
            webSocket = new WebSocket("ws://localhost:9080/snstry/echo");
               // webSocket = new WebSocket("ws://54.209.64.147:8080/echo");
               // webSocket = new WebSocket("ws://54.209.64.147:8080/echo");
                
              webSocket1=new WebSocket("ws://localhost:9080/snstry/WebSocket");
                //webSocket1=new WebSocket("ws://54.209.64.147:8080/WebSocket");
              //webSocket = new WebSocket("ws://54.209.64.147:8080/echo");
                ...
                webSocket1.onclose = function(event){
                    writeResponse("Connection 2 closed");
                };
            }
     	...
     	<script async defer
        src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDJExaHJk9XpC28JZwVhhMzW-UsKDt86HQ&libraries=visualization&callback=initMap">
    	</script>  
    </body>
</html>